...
interface AuthContextType {
  ...
  register: (name: string, email: string, password: string, extras?: RegisterExtras) => Promise<boolean>;
...
export const AuthProvider: React.FC<{ children: React.ReactNode }> = ({ children }) => {
  ...
  const logout = async () => {
    // Clear the local session immediately so logout never hangs on a slow
    // or unreachable backend; server-side token revocation is best-effort.
