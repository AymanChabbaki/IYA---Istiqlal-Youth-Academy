            ...
            >
              ...
              <Card className="p-8">
                <p className="text-lg text-muted-foreground leading-relaxed">
                  Welcome to Istiqlal Youth Academy. By accessing or using our platform, you agree to be bound by these 
              ...
              <div>
                ...
                <Card className="p-6 space-y-4">
                  <p className="text-muted-foreground">
                    By creating an account, accessing, or using the Istiqlal Youth Academy platform, you acknowledge 
              ...
              <div>
                ...
                <Card className="p-6 space-y-4">
                  <p className="text-muted-foreground">
                    All content on the Istiqlal Youth Academy platform, including text, graphics, logos, and software, 
                    is the property of Istiqlal Youth Academy or its licensors and is protected by copyright and other 
              ...
              <div>
                ...
                <Card className="p-6 space-y-4">
                  <p className="text-muted-foreground">
                    Istiqlal Youth Academy is provided "as is" without warranties of any kind. We are not liable for 
              ...
              <div>
                ...
                <Card className="p-6">
                  ...
                  <div className="space-y-2 text-muted-foreground">
                    <p>Email: <a href="mailto:legal@istiqlalyouthacademy.org" className="text-primary hover:underline">legal@istiqlalyouthacademy.org</a></p>
