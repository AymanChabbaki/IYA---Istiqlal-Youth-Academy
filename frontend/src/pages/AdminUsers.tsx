      ...
      <Dialog open={editDialog.open} onOpenChange={(open) => setEditDialog({ open, user: null })}>
        <DialogContent className="max-w-2xl max-h-[90vh] overflow-y-auto">
          ...
          <div className="space-y-6 py-4">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                ...
                {formData.role === 'STAFF' && (
                  <div className="space-y-2">
                    ...
                    <Input
                      id="edit-staffRole"
                      placeholder="e.g., Regional Coordinator, City President"
            ...
            {/* Section 2b: Region & Committee */}
            <div className="space-y-4">
              <h4 className="text-sm font-semibold text-primary uppercase tracking-wider">Region & Committee</h4>
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                <div className="space-y-2">
                ...
                <div className="space-y-2">
                  <Label htmlFor="edit-iqlim">Iqlim / Province</Label>
                  <Input
                    id="edit-iqlim"
              ...
              <div className="flex items-start gap-6 p-6 bg-gradient-to-br from-primary/10 via-secondary/10 to-accent/10 rounded-xl border">
                ...
                <div className="flex-1 min-w-0">
                  ...
                  <div className="flex flex-wrap gap-2">
                    ...
                    {viewDialog.user.committee && (
                      <Badge variant="outline" className="text-sm px-3 py-1">
                        {viewDialog.user.committee.name}
                      </Badge>
                    )}
                    {viewDialog.user.region && (
                      <Badge variant="outline" className="text-sm px-3 py-1">
                        {MOROCCO_REGIONS.find((r) => r.value === viewDialog.user.region)?.label || viewDialog.user.region}
                      </Badge>
                    )}
                    {viewDialog.user.city && (
                      <Badge variant="outline" className="text-sm px-3 py-1">
                        {viewDialog.user.city}
                      </Badge>
                    )}
