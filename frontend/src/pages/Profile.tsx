...
const Profile = () => {
  ...
  const fetchUserData = async () => {
    try {
      ...
      setFormData({
        ...
        iqlim: userData.iqlim || '',
        city: userData.city || '',
        committeeId: userData.committeeId || '',
      });
    } catch (error: any) {
  ...
  const digitalBadgeData = JSON.stringify({
    ...
    organization: 'Istiqlal Youth Academy',
          ...
          <Card className="p-8 shadow-2xl border-2 mb-8">
            <div className="flex flex-col md:flex-row items-center gap-8">
              ...
              <div className="flex-1 text-center md:text-left">
                ...
                {(user?.committee || user?.region || user?.city) && (
                  <div className="flex flex-wrap gap-2 justify-center md:justify-start">
                    {user?.committee && (
                      <Badge variant="outline">{user.committee.name}</Badge>
                    )}
                    {user?.region && (
                      <Badge variant="outline">
                        {MOROCCO_REGIONS.find((r) => r.value === user.region)?.label || user.region}
                      </Badge>
                    )}
                  ...
                  <Card className="overflow-hidden bg-gradient-to-br from-primary via-primary/90 to-secondary shadow-xl">
                    ...
                    <div className="bg-white/10 backdrop-blur-sm p-4 border-b border-white/20">
                      <div className="flex items-center gap-3 mb-2">
                        ...
                        <div className="flex-1">
                          <h3 className="text-white font-bold text-sm">Istiqlal Youth Academy</h3>
                    ...
                    <div className="bg-white/10 backdrop-blur-sm p-3 border-t border-white/20 space-y-1.5">
                      <div className="flex items-center gap-2 text-white/90 text-xs">
                        ...
                        <span className="truncate">contact@istiqlalyouthacademy.org</span>
                      </div>
                      <div className="flex items-center gap-2 text-white/90 text-xs">
                        <Globe className="h-3 w-3 flex-shrink-0" />
                        <span className="truncate">istiqlalyouthacademy.org</span>
                      </div>
                      <div className="flex items-center gap-2 text-white/90 text-xs">
                  ...
                  <div className="grid md:grid-cols-2 gap-6">
                    ...
                    <div>
                      ...
                      <Select
                        ...
                        onValueChange={(value) => setFormData({ ...formData, committeeId: value })}
                      >
                    ...
                    <div className="grid grid-cols-2 gap-4">
                      ...
                      <div>
                        <Label htmlFor="iqlim">Iqlim / Province</Label>
                        <Input
                          id="iqlim"
                          value={formData.iqlim}
                          onChange={(e) => setFormData({ ...formData, iqlim: e.target.value })}
                          className="mt-2"
                        />
                      </div>
                    </div>
