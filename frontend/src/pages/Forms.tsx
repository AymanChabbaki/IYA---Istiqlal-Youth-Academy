...
const Forms = () => {
  ...
  const renderField = (field: FormField) => {
    ...
    const labelElement = (
      <Label htmlFor={field.id} className="text-lg font-semibold text-foreground mb-3 block">
          ...
          <div className="space-y-3">
            ...
            <div className="relative group/input">
              <Input
                ...
                className="h-14 bg-card border-border rounded-2xl px-6 focus:ring-2 focus:ring-primary/20 focus:border-primary/50 transition-all duration-300 text-foreground placeholder:text-muted-foreground/60"
          ...
          <div className="space-y-3">
            ...
            <div className="relative group/input">
              <Textarea
                ...
                placeholder={placeholder}
                rows={5}
                className="bg-card border-border rounded-2xl px-6 py-4 focus:ring-2 focus:ring-primary/20 focus:border-primary/50 transition-all duration-300 text-foreground placeholder:text-muted-foreground/60 resize-none"
                required={field.required}
              />
              <div className="absolute inset-0 rounded-2xl bg-primary/5 opacity-0 group-hover/input:opacity-100 pointer-events-none transition-opacity" />
            </div>
    ...
    <div className="min-h-screen">
      ...
      <section className="relative -mt-[4.5rem] pt-40 md:pt-48 pb-16 overflow-hidden z-10 gradient-hero noise">
        ...
        <div className="container mx-auto px-4 relative z-10">
          ...
          >
            <p className="section-label justify-center mb-6">Contribute</p>

            <h1 className="font-display font-black uppercase text-foreground mb-6 tracking-tight leading-[0.9] text-6xl md:text-8xl">
              Voice your
            ...
            <p dir="rtl" className="font-display font-bold text-xl text-muted-foreground/70 mb-4">
              شارك برأيك في استمارات الأكاديمية
            </p>

            <p className="text-lg md:text-xl text-muted-foreground mb-12 max-w-2xl mx-auto leading-relaxed">
              Surveys and forms that feed directly into the academy's decisions. Your input shapes what we do next.
            </p>
            ...
            <div className="grid grid-cols-2 md:grid-cols-4 gap-4 max-w-3xl mx-auto">
              {[
                ...
                <motion.div
                  ...
                  className="bg-card border border-border backdrop-blur-xl rounded-2xl p-4 text-center group hover:bg-muted transition-all cursor-default"
                >
          ...
          {!selectedForm ? (
              ...
              <div className="flex flex-col md:flex-row items-center justify-between gap-6 mb-12">
                <div className="flex items-center gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-muted-foreground">Explore and contribute to our active projects</p>
                  </div>
                </div>
                
                <div className="flex gap-2">
                  <Badge variant="secondary" className="px-4 py-2 bg-card hover:bg-muted border-border transition-colors cursor-pointer">All Forms</Badge>
                  <Badge variant="outline" className="px-4 py-2 border-border hover:border-primary/50 transition-colors cursor-pointer">Archived</Badge>
                </div>
              </div>
                ...
                <AnimatePresence mode="popLayout">
                  {forms.map((form, index) => {
                    ...
                    return (
                      ...
                      >
                        <Card 
                          className="group relative h-full bg-card border-border backdrop-blur-2xl overflow-hidden hover:bg-white/[0.08] hover:border-primary/30 transition-all duration-500 cursor-pointer"
                        ...
                        >
                          ...
                          <div className="p-8 flex flex-col h-full">
                            <div className="flex justify-between items-start mb-6">
                              <div className="p-3 rounded-2xl bg-primary/10 border border-primary/20 text-primary group-hover:scale-110 group-hover:bg-primary group-hover:text-foreground transition-all duration-500">
                              ...
                              <div className="flex gap-2">
                                <Button 
                                  variant="ghost" 
                                  size="icon" 
                                  className="h-9 w-9 rounded-xl bg-card border border-border hover:bg-primary hover:border-primary text-foreground transition-all"
            ...
            >
              {(() => {
                ...
                return (
                  <Card className="relative bg-card border-border backdrop-blur-3xl overflow-hidden shadow-2xl">
                    {/* Header accent */}
                    ...
                    <div className="p-8 md:p-12">
                      <div className="flex flex-col md:flex-row md:items-center justify-between gap-6 mb-12">
                        ...
                        <Button
                          ...
                          className="self-start md:self-center text-muted-foreground hover:text-foreground hover:bg-card gap-2 px-6"
                        >
                          Cancel Process
                        </Button>
                      </div>

                      <div className="mb-10 h-[1px] bg-muted" />
