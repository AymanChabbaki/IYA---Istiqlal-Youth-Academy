...
const AdminSettings = () => {
  ...
  const [generalSettings, setGeneralSettings] = useState({
    siteName: 'Istiqlal Youth Academy',
    siteDescription: 'A community for AI and development enthusiasts',
    siteUrl: 'https://istiqlalyouthacademy.org',
    contactEmail: 'contact@istiqlalyouthacademy.org',
  ...
  const [emailSettings, setEmailSettings] = useState({
    ...
    smtpUser: '',
    smtpPassword: '',
    fromEmail: 'noreply@istiqlalyouthacademy.org',
    fromName: 'Istiqlal Youth Academy',
  });
