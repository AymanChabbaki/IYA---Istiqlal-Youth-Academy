            ...
            >
              ...
              <Card className="p-8">
                <p className="text-lg text-muted-foreground leading-relaxed">
                  At Istiqlal Youth Academy, we take your privacy seriously. This Privacy Policy explains how we collect, use, 
              ...
              <div>
                ...
                <Card className="p-6">
                  ...
                  <div className="space-y-2 text-muted-foreground">
                    <p>Email: <a href="mailto:privacy@istiqlalyouthacademy.org" className="text-primary hover:underline">privacy@istiqlalyouthacademy.org</a></p>
