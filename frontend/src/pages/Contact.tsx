  ...
  const contactInfo = [
    {
      icon: Mail,
      title: 'Email',
      value: 'contact@istiqlalyouthacademy.org',
      link: 'mailto:contact@istiqlalyouthacademy.org',
      color: 'gradient-primary',
    },
    {
      icon: MessageCircle,
      title: 'Instagram',
      value: '@istiqlalyouthacademy',
      link: 'https://www.instagram.com/istiqlalyouthacademy',
      color: 'gradient-primary',
    },
    {
      icon: MapPin,
    ...
    },
    {
      ...
      value: 'Mon - Fri: 9AM - 6PM (Morocco time)',
      color: 'gradient-primary',
    },
  ];
      ...
      <section className="relative py-32 md:py-40 overflow-hidden -mt-[4.5rem] pt-48 md:pt-56 gradient-hero noise">
        ...
        <motion.div style={{ y: y1, opacity }} className="absolute inset-0 pointer-events-none">
          <div className="absolute top-20 left-10 opacity-20">
            ...
            >
              <MessageCircle className="h-32 w-32 text-foreground" />
            </motion.div>
          </div>
          <div className="absolute top-40 right-20 opacity-20">
            ...
            >
              <Mail className="h-24 w-24 text-foreground" />
            </motion.div>
          </div>
          <div className="absolute bottom-20 left-1/4 opacity-20">
            ...
            >
              <Send className="h-28 w-28 text-foreground" />
            </motion.div>
          </div>
        </motion.div>
            ...
            {contactInfo.map((info, index) => (
              ...
              >
                <Card className="p-6 shadow-card hover:shadow-glow transition-all h-full">
                  <motion.div
                    className={`inline-flex items-center justify-center w-14 h-14 rounded-2xl ${info.color} mb-4`}
      ...
      <section className="py-20">
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto">
            ...
            >
              <p className="section-label justify-center mb-5">Send message</p>
              <h2 className="font-display font-black uppercase tracking-tight leading-[0.95] text-4xl md:text-6xl mb-4">Drop us <span className="gradient-text">a line.</span></h2>
