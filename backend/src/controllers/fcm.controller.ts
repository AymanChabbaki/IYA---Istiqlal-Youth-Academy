...
export const sendToToken = asyncHandler(async (req: Request, res: Response) => {
  ...
  try {
    const message: any = {
      ...
      data: { title: 'Test notification', body: 'This is a test message', url: process.env.FRONTEND_URL || 'https://istiqlalyouthacademy.vercel.app' },
      webpush: {
        notification: { icon: '/logo.png' },
        fcmOptions: { link: process.env.FRONTEND_URL || 'https://istiqlalyouthacademy.vercel.app' },
      },
    };
