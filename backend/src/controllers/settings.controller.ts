...
export const initializeSettings = asyncHandler(async (req: AuthRequest, res: Response) => {
  const defaultSettings = [
    // General
    { key: 'general.siteName', value: 'Istiqlal Youth Academy', category: 'general' },
    { key: 'general.siteDescription', value: 'A community for AI and development enthusiasts', category: 'general' },
    { key: 'general.siteUrl', value: 'https://istiqlalyouthacademy.org', category: 'general' },
    { key: 'general.contactEmail', value: 'contact@istiqlalyouthacademy.org', category: 'general' },
    ...
    { key: 'email.fromEmail', value: 'noreply@istiqlalyouthacademy.org', category: 'email' },
    { key: 'email.fromName', value: 'Istiqlal Youth Academy', category: 'email' },
  ];
