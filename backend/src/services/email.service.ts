...
export const sendEmail = async (options: EmailOptions): Promise<boolean> => {
  try {
    ...
    const mailOptions = {
      from: `"${process.env.SMTP_FROM_NAME || 'Istiqlal Youth Academy'}" <${process.env.SMTP_FROM_EMAIL || process.env.SMTP_USER}>`,
      to: options.to,
...
export const emailTemplates = {
  registrationApproved: (
    ...
    const fe = eventDetails?.frontendUrl || process.env.FRONTEND_URL || 'https://istiqlalyouthacademy.vercel.app';
    ...
    const logoUrl = 'https://istiqlalyouthacademy.vercel.app/logo.png';
        ...
        <body>
          <div class="wrapper">
            <table class="main" align="center" width="100%">
              <tr>
                <td class="header">
                  <img src="${logoUrl}" alt="Istiqlal Youth Academy" class="logo">
              ...
              <tr>
                <td class="content">
                  ...
                  <div class="agenda-section">
                    ...
                    ${subEvents.map(se => `
                      <div class="agenda-item">
                        ...
                        <span class="agenda-time">⏱️ ${new Date(se.startAt).toLocaleDateString('en-GB')} ${new Date(se.startAt).toLocaleTimeString([], { hour: '2-digit', minute: '2-digit' })} to ${new Date(se.endAt).toLocaleDateString('en-GB')} ${new Date(se.endAt).toLocaleTimeString([], { hour: '2-digit', minute: '2-digit' })}</span>
                  ...
                  <p style="margin-top: 40px; font-size: 14px; color: #4b5563;">Best regards,<br/><strong style="color: #000;">Istiqlal Youth Academy Global Command</strong></p>
                </td>
              </tr>
              <tr>
                <td class="footer">
                  <div class="social-links">
                    <a href="https://istiqlalyouthacademy.vercel.app">Official Website</a>
                    <a href="${fe}/contact">Support Core</a>
                  </div>
                  <p>© 2026 Istiqlal Youth Academy. Pulse Network Synchronization Complete.</p>
    ...
    <body>
      <div class="wrapper">
        ...
        <div class="content">
          ...
          <p>Stay secure,<br><strong>Istiqlal Youth Academy Team</strong></p>
        </div>
        <div class="footer">
          <p>© ${new Date().getFullYear()} Istiqlal Youth Academy. All rights reserved.</p>
        ...
        <body>
          <div class="container">
            ...
            <div class="content">
              ...
              <p>Best regards,<br/>Istiqlal Youth Academy Team</p>
            </div>
            <div class="footer">
              <p>© ${new Date().getFullYear()} Istiqlal Youth Academy. All rights reserved.</p>
            </div>
